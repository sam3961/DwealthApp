...
public class IndivisualActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_indivisual);
        ButterKnife.bind(this);
        customToolBarWithBack(toolBar, getResources().getString(R.string.indivisual_sequrety), this);
        setGraph();
    ...
    private void buySellDialog() {
        ...
        final View view = factory.inflate(R.layout.view_buy_sell_dialog, null);
    ...
    @OnClick({R.id.buttonBuy, R.id.buttonSell})
